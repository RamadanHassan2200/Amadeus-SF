...
if (check_Ticket == "-"){
    capture line:2, column:30, length:14 assign to ticket7
}
...
if (check_Ticket == "-"){
    capture line:2, column:45, length:14 assign to ticket8
}
capture line:3, column:63, length:1 assign to check_Ticket
if (check_Ticket == "-"){
    capture line:2, column:60, length:4 assign to ticket9
    capture line:3, column:2, length:10 assign to remaining_Ticket_Part
    append remaining_Ticket_Part to ticket9
}
