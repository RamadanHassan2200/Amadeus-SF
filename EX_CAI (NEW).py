...
assign "0" to airlinePercentage
if (Airline1 == "SM"){
    assign "3" to airlinePercentage
}
if (Airline1 == "MS"){
    if (MSClassCheck == "True"){
        assign "1" to airlinePercentage
    }
    else{
        assign "3" to airlinePercentage
    }
...
capture line:1, column:1, length:8 assign to checkError
if (checkError=="**ATTN**"){
...
if (checkError=="TICKET DESIGNATOR"){
    ...
    assign "0" to FirstEGP
        capture line:10, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:10, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:11, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:11, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:12, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:12, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:13, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:13, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:14, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:14, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:15, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:15, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:16, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:16, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:17, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:17, line:4, length:10 assign to FirstEGP
            }
        }
        capture line:18, column:1, length:3 assign to checkFirstEGP
        if (FirstEGP == "0"){
            if (checkFirstEGP == "EGP"){
                capture line:18, line:4, length:10 assign to FirstEGP
            }
        }
